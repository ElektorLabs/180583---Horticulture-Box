...
void eepwrite_ledsettings(ledsettings_t data){
  eepwrite_struct( ( (void*)(&data) ), sizeof(ledsettings_t) , LEDSETTINGS_START );  
}
...
ledsettings_t eepread_ledsettings( void ){
  ...
  if(false == eepread_struct( (void*)(&retval), sizeof(ledsettings_t) , LEDSETTINGS_START ) ){ 
    Serial.println("LED CONF");
    bzero((void*)&retval,sizeof( ledsettings_t ));
    retval = LED_GetDefaultSettings();
